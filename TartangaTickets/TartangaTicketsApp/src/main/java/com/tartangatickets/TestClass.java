...
//                new Department("INF", "Informática"),
//                null);
//        Ticket ticket = new Ticket(new Date(), null, "001", new Department("INF", "Informática"), "Aula 1", State.OPEN, user, null, null);
//        try {
...
//                new Department("INF", "Informática"),
//                null);
//        Ticket ticket = new Ticket(null, null, "001", new Department("INF", "Informática"), "Aula 1", State.OPEN, user, null, null);
